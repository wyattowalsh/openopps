...
Discovery does not apply, activate, or share a run with `openopps sync`. Plugin skills do not perform live Cloudflare Workers upload, Kaggle mutation, hosted-alpha, v7 7.6, or source-policy 1780 publication. Alembic `0005` and `0006_url_pull_runs` have already landed; skills must not author further revisions.
