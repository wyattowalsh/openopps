	...
	return (
		<div className="fixed inset-0 z-50 lg:hidden">
			...
			<div
				ref={dialogRef}
				className={cn(
					"absolute inset-x-0 bottom-0 flex max-h-[88vh] min-h-0 flex-col overflow-hidden rounded-t-[1.4rem] border border-border/75 bg-card/95 shadow-[0_-24px_80px_color-mix(in_oklab,var(--foreground)_12%,transparent)]",
					"motion-safe:animate-in motion-safe:slide-in-from-bottom motion-safe:duration-300",
				)}
				tabIndex={-1}
				{...getJobsBoardPreviewSheetDialogProps()}
			>
				<div className="flex shrink-0 items-center justify-end border-b border-border/70 px-3 py-2">
					<h2
