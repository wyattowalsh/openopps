...
```bash
openopps sources list --json
openopps sources show <source-id> --json
openopps sources sync --json
```
...
uv run python scripts/audit.py skills/openopps-sources/
uv run python scripts/package.py skills/openopps-sources/ --dry-run
```
