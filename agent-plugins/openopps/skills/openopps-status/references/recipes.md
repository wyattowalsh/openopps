...
Doctor is a local checklist, not a live ATS probe.
...
uv run python scripts/audit.py skills/openopps-status/
uv run python scripts/package.py skills/openopps-status/ --dry-run
```
