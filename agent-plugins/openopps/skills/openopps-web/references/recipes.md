...
Read-only HTTPS GET. Do not drive a browser.

- https://www.openopps.dev/
- https://www.openopps.dev/explorer
- https://www.openopps.dev/docs
- https://www.openopps.dev/docs/agent-plugins
- https://www.openopps.dev/llms.txt
- https://www.openopps.dev/llms-full.txt
- https://www.openopps.dev/llms.mdx/docs/cli

Refuse `/api/`, `/api/jobs/search`, Wrangler, and Kaggle.
...
uv run python scripts/audit.py skills/openopps-web/
uv run python scripts/package.py skills/openopps-web/ --dry-run
```
