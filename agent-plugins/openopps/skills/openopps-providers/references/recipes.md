...
```bash
openopps providers detect https://boards.greenhouse.io/example --json
openopps providers inspect greenhouse --json
openopps providers capabilities greenhouse --json
openopps providers health --json
openopps providers coverage --json
openopps providers audit --json
```

Health persists only with `--apply`. Coverage/audit do not fetch live jobs.
...
uv run python scripts/audit.py skills/openopps-providers/
uv run python scripts/package.py skills/openopps-providers/ --dry-run
```
