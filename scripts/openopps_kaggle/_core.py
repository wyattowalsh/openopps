    ...
    return {
        "cells": [
            _markdown_cell(
                ...
                "Alembic schema when needed, then runs `openopps sync "
                "--metrics-json` (packaged catalog sources, boards, and jobs) "
                "under a 6000s budget so a full public snapshot can land even "
                "when the prior version is the synthetic example seed. It captures status "
