    ...
    (
        Resource(
            ...
            description=(
                ...
                "table DDL and nulls bulky text and JSON mirrors so Kaggle can "
...
- `openoppsdb.sqlite`: the SQLite ledger, including metadata tables named `openopps_tables` and `openopps_columns`. To keep Kaggle table previews indexable, this read-only upload copy uses plain table DDL and nulls bulky text/JSON mirrors after export: `job_versions.description_html`, `job_versions.job_description`, and `job_payload_snapshots.payload`.
