...
GETRO_SOURCE_CATALOG = {
    ...
    "av": SourceRecord(
        key="av",
        url="https://jobs.av.vc/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "av"},
    ),
    "basisset": SourceRecord(
        key="basisset",
        url="https://jobs.basisset.com/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "basisset"},
    ),
    "motivepartners": SourceRecord(
        key="motivepartners",
        url="https://motivepartners.getro.com/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "motivepartners"},
    ),
    "recyclesaurus": SourceRecord(
        key="recyclesaurus",
        url="https://jobs.recyclesaurus.com/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "recyclesaurus"},
    ),
    "startupmaine": SourceRecord(
        key="startupmaine",
        url="https://jobs.startupmaine.org/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "startupmaine"},
    ),
    "jenniferbangoura": SourceRecord(
        key="jenniferbangoura",
        url="https://jenniferbangoura.getro.com/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "jenniferbangoura"},
    ),
    "polygon": SourceRecord(
        key="polygon",
        url="https://ecosystemjobs.polygon.technology/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "polygon"},
    ),
    "oktaventures": SourceRecord(
        key="oktaventures",
        url="https://oktaventures.getro.com/jobs",
        provider_id="getro",
        raw_metadata={"collectionId": "oktaventures"},
    ),
    "hortiheroes": SourceRecord(
        key="hortiheroes",
        url="https://jobs.hortiheroes.com/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "hortiheroes"},
    ),
    "outforundergrad": SourceRecord(
        key="outforundergrad",
        url="https://careers.outforundergrad.org/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "outforundergrad"},
    ),
    "jpro": SourceRecord(
        key="jpro",
        url="https://jobs.jpro.org/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "jpro"},
    ),
    "cdfms": SourceRecord(
        key="cdfms",
        url="https://jobs.cdfms.org/companies",
        provider_id="getro",
        raw_metadata={"collectionId": "cdfms"},
    ),
}
...
class GetroSourceAdapter:
    ...
    async def iter_boards(
        ...
        *,
        ...
        configured_collection_id = source.raw_metadata.get("collectionId")
        # Only numeric collectionId values are usable Getro API ids; slugs fall through to discovery.
        collection_id = (
            configured_collection_id
            if isinstance(configured_collection_id, str)
            and configured_collection_id.isdigit()
            else await self._discover_collection_id(client, source)
        )
