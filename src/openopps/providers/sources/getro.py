...
ECONOMICDEVELOPMENTJOBS_SOURCE = SourceRecord(
...
TECHSQUAREVENTURES_SOURCE = SourceRecord(
...
AMAZINGCOLUMBUSGA_SOURCE = SourceRecord(
...
PORTMUSKOGEE_SOURCE = SourceRecord(
    key="portmuskogee",
...
POWERLINES_SOURCE = SourceRecord(
    key="powerlines",
...
THECENTERMEMPHIS_SOURCE = SourceRecord(
...
SILVERSMITH_SOURCE = SourceRecord(
    key="silversmith",
...
LIMITLESSDECATUR_SOURCE = SourceRecord(
...
WORKUPCOWETA_SOURCE = SourceRecord(
    key="workupcoweta",
...
HELLOWESTMICHIGAN_SOURCE = SourceRecord(
...
PORTAGEINVESTVC_SOURCE = SourceRecord(
    key="portageinvestvc",
...
FIRSTMOMENTUM_SOURCE = SourceRecord(
    key="firstmomentum",
...
MERANTIXAICAMPUS_SOURCE = SourceRecord(
...
MOTHERVENTURES_SOURCE = SourceRecord(
    key="motherventures",
...
SPECTRUMEQUITY_SOURCE = SourceRecord(
    key="spectrumequity",
...
OMNIVOREVC_SOURCE = SourceRecord(
    key="omnivorevc",
...
INVESTNEBRASKA_SOURCE = SourceRecord(
    key="investnebraska",
...
FIRSTMILEVC_SOURCE = SourceRecord(
    key="firstmilevc",
...
LEADERSHIPTRIANGLE_SOURCE = SourceRecord(
...
FANNINDEVELOPMENT_SOURCE = SourceRecord(
...
DEVELOPMILLEDGEVILLE_SOURCE = SourceRecord(
...
SWANANDLEGEND_SOURCE = SourceRecord(
    key="swanandlegend",
...
BLACKWELLNOW_SOURCE = SourceRecord(
    key="blackwellnow",
...
EMANUELCHAMBER_SOURCE = SourceRecord(
    key="emanuelchamber",
...
HANNAHGREY_SOURCE = SourceRecord(
    key="hannahgrey",
...
FINTECHAUSTRALIA_SOURCE = SourceRecord(
...
JOHOTALENT_SOURCE = SourceRecord(
    key="johotalent",
...
LIFEMULTIPLIED_SOURCE = SourceRecord(
    key="lifemultiplied",
...
SPRINGTIDE_SOURCE = SourceRecord(
    key="springtide",
...
INFLECTION_SOURCE = SourceRecord(
    key="inflection",
...
TERRATALENT_SOURCE = SourceRecord(
    key="terratalent",
...
MOVEMENTLABS_SOURCE = SourceRecord(
    key="movementlabs",
...
WALLSTREETFRIENDS_SOURCE = SourceRecord(
...
LEEDSILLUMINATE_SOURCE = SourceRecord(
    key="leedsilluminate",
...
Z2SIXTYVENTURES_SOURCE = SourceRecord(
    key="z2sixtyventures",
...
ANIMOCABRANDS_SOURCE = SourceRecord(
    key="animocabrands",
...
TPYCAPITAL_SOURCE = SourceRecord(
    key="tpycapital",
...
SHARPALPHAADVISORS_SOURCE = SourceRecord(
...
COEFFICIENTCAP_SOURCE = SourceRecord(
    key="coefficientcap",
...
DYRDEKMACHINE_SOURCE = SourceRecord(
    key="dyrdekmachine",
...
OCTOPUSENERGYGENERATION_SOURCE = SourceRecord(
...
COLORINTECH_SOURCE = SourceRecord(
    key="colorintech",
...
BOOMTOWNACCELERATORS_SOURCE = SourceRecord(
...
RALLYDAYPARTNERS_SOURCE = SourceRecord(
...
COMMUNITIESINSCHOOLS_SOURCE = SourceRecord(
...
ACGPARTNERS_SOURCE = SourceRecord(
    key="acgpartners",
...
RUBICONFOUNDERS_SOURCE = SourceRecord(
    key="rubiconfounders",
...
PRELUDEGROWTH_SOURCE = SourceRecord(
    key="preludegrowth",
...
OCAVENTURES_SOURCE = SourceRecord(
    key="ocaventures",
...
INDUSTRIALINNOVATIONFUND_SOURCE = SourceRecord(
...
THEPRODUCTIONBOARD_SOURCE = SourceRecord(
...
WESLEYCLOVER_SOURCE = SourceRecord(
    key="wesleyclover",
...
VOLTAVENTURES_SOURCE = SourceRecord(
    key="voltaventures",
...
ENTRADAVENTURES_SOURCE = SourceRecord(
    key="entradaventures",
...
KARMIJNKAPITAAL_SOURCE = SourceRecord(
    key="karmijnkapitaal",
...
AKMAZOCAPITAL_SOURCE = SourceRecord(
    key="akmazocapital",
...
MERYLBREIDBART_SOURCE = SourceRecord(
    key="merylbreidbart",
...
THECENTERBHAM_SOURCE = SourceRecord(
    key="thecenterbham",
...
BOYDINNOVATIONCENTER_SOURCE = SourceRecord(
...
DEMOCRACYFUND_SOURCE = SourceRecord(
    key="democracyfund",
...
EVANWALDEN_SOURCE = SourceRecord(
    key="evanwalden",
...
WESTPORTYOUTHCOMMISSION_SOURCE = SourceRecord(
...
FCVENTURES_SOURCE = SourceRecord(
    key="fcventures",
...
THEMBAFUND_SOURCE = SourceRecord(
    key="thembafund",
...
VERTEXVENTURESVC_SOURCE = SourceRecord(
...
VISTAEQUITYPARTNERS_SOURCE = SourceRecord(
...
BORDERLESSCAPITAL_SOURCE = SourceRecord(
...
GLYNNCAPITAL_SOURCE = SourceRecord(
    key="glynncapital",
...
CSACCELERATOR_SOURCE = SourceRecord(
    key="csaccelerator",
...
VENTURES406_SOURCE = SourceRecord(
    key="406ventures",
...
JANUARYCAPITAL_SOURCE = SourceRecord(
    key="januarycapital",
...
BEEPARTNERS_SOURCE = SourceRecord(
    key="beepartners",
...
DEMOCAPITAL_SOURCE = SourceRecord(
    key="democapital",
...
SAASCAPITAL_SOURCE = SourceRecord(
    key="saascapital",
...
ASSEMBLEDBRANDS_SOURCE = SourceRecord(
    key="assembledbrands",
...
ACADIANVENTURES_SOURCE = SourceRecord(
    key="acadianventures",
...
RALEIGHFOUNDED_SOURCE = SourceRecord(
    key="raleighfounded",
...
VOLTCAPITAL_SOURCE = SourceRecord(
    key="voltcapital",
...
CALIBRATEVC_SOURCE = SourceRecord(
    key="calibratevc",
...
CATALYTICCAPITAL_SOURCE = SourceRecord(
...
PHOTONJOBS_SOURCE = SourceRecord(
    key="photonjobs",
...
IMAGINABLEFUTURES_SOURCE = SourceRecord(
...
CINTRIFUSE_SOURCE = SourceRecord(
    key="cintrifuse",
...
MAZEIMPACT_SOURCE = SourceRecord(
    key="mazeimpact",
...
FINTOPCAPITAL_SOURCE = SourceRecord(
    key="fintopcapital",
...
ETHICSINSOCIETY_SOURCE = SourceRecord(
    key="ethicsinsociety",
...
MYSTARTUPGIG_SOURCE = SourceRecord(
    key="mystartupgig",
...
HEARTCOREVC_SOURCE = SourceRecord(
    key="heartcorevc",
...
INFLECTIONVC_SOURCE = SourceRecord(
    key="inflectionvc",
...
MOONFIREVC_SOURCE = SourceRecord(
    key="moonfirevc",
...
TEKFENVENTURES_SOURCE = SourceRecord(
    key="tekfenventures",
...
DISCOVERTECHNATA_SOURCE = SourceRecord(
...
ITSPRONOUNCEDDATA_SOURCE = SourceRecord(
...
RITUALCAPITAL_SOURCE = SourceRecord(
    key="ritualcapital",
...
THECLIMATEPLEDGE_SOURCE = SourceRecord(
...
SHAKOPEEMN_SOURCE = SourceRecord(
    key="shakopeemn",
...
LORIMERVENTURES_SOURCE = SourceRecord(
    key="lorimerventures",
...
RITUALCAPITALJOBS_SOURCE = SourceRecord(
...
SHAKOPEEMNJOBS_SOURCE = SourceRecord(
    key="shakopeemnjobs",
...
THECLIMATEPLEDGEJOBS_SOURCE = SourceRecord(
...
DRAPERSTARTUPHOUSE_SOURCE = SourceRecord(
...
ZILLIQAJOBS_SOURCE = SourceRecord(
    key="zilliqajobs",
