...
| `docs_data.py`      | Deterministic package-derived metadata for the docs site               | Keep            | Prevents duplicated provider/source/export counts in docs and generated site surfaces.                                           |
| `enrichment.py`     | Deterministic normalized job enrichment                                | Keep            | Isolated transformation logic.                                                                                                   |
| `examples.py`       | Deterministic demo data                                                | Keep            | Useful for smoke tests and docs examples without network access.                                                                 |
