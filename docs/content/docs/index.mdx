...
| [Dataset Explorer](/docs/explorer)   | Search the generated board, route, and latest-job snapshot.                   |
| [Jobs board](/jobs)                  | Filter and preview open roles from the static search index.                   |
