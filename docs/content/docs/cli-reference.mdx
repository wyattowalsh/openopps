...
Plugins are discovered through Python entry points in the `openopps.plugins` group. Installed Python plugins are not sandboxed; install only plugins you trust.
