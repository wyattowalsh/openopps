...
- Keep frontmatter titles/descriptions concise and source-grounded. Current pages are `index`, `cli-reference`, `configuration`, `providers`, `explorer`, and `operations`.
