...
| Supported Python and lowest-dependency contracts are untested | P2 | CI | 6.4 | 3.12/3.13/3.14 and lowest-direct lanes | repo-verified gate configuration; exact-SHA origin run open |
...
| Production readiness lacks exact-SHA origin/deployment smoke | P1 | release | 6.8-6.9 | local gates plus exact-SHA CI and both deployments | proof-open/live-gated |
...
- No push or exact-SHA origin CI/deployment smoke is recorded for this working tree. No ordinary v6-tree deletion, mirror bundle, ref inventory, history rewrite, or force-push was attempted.
