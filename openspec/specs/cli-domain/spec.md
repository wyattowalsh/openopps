...
## Purpose
Define the stable OpenOpps CLI domain, including workflow-oriented command grouping, scriptable output contracts, and filtering behavior for sources, boards, jobs, providers, and database operations.
## Requirements
