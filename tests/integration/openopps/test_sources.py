...
def test_source_catalog_includes_requested_portfolio_boards():
    expected = {
        ...
        "fcventures": (
            "getro",
            "https://careers.fcventures.com/companies",
            "collectionId",
            "fcventures",
        ),
        "thembafund": (
            "getro",
            "https://jobs.thembafund.com/companies",
            "collectionId",
            "thembafund",
        ),
        "blacknova": (
            "getro",
            "https://jobs.blacknova.vc/companies",
            "collectionId",
            "blacknova",
        ),
        "vertexventuresvc": (
            "getro",
            "https://jobs.vertexventures.com/companies",
            "collectionId",
            "vertexventuresvc",
        ),
        "vistaequitypartners": (
        ...
        "graduate": (
            "getro",
            "https://jobs.graduate.nl/companies",
            "collectionId",
            "graduate",
        ),
        "borderlesscapital": (
        ...
        "glynncapital": (
            "getro",
            "https://jobs.glynncapital.com/companies",
            "collectionId",
            "glynncapital",
        ),
        "csaccelerator": (
            "getro",
            "https://jobs.csaccelerator.com/companies",
            "collectionId",
            "csaccelerator",
        ),
        "crossbeam": (
            "getro",
            "https://jobs.crossbeam.vc/companies",
            "collectionId",
            "crossbeam",
        ),
        "gtrlink": (
            "getro",
            "https://jobs.gtrlink.org/companies",
            "collectionId",
            "gtrlink",
        ),
        "406ventures": (
            "getro",
            "https://jobs.406ventures.com/companies",
            "collectionId",
            "406ventures",
        ),
        "januarycapital": (
            "getro",
            "https://jobs.january.capital/companies",
            "collectionId",
            "januarycapital",
        ),
        "beepartners": (
            "getro",
            "https://jobs.beepartners.vc/companies",
            "collectionId",
            "beepartners",
        ),
        "democapital": (
            "getro",
            "https://www.democapital.xyz/companies",
            "collectionId",
            "democapital",
        ),
        "saascapital": (
            "getro",
            "https://careers.saas-capital.com/companies",
            "collectionId",
            "saascapital",
        ),
        "assembledbrands": (
            "getro",
            "https://jobs.assembledbrands.com/companies",
            "collectionId",
            "assembledbrands",
        ),
        "acadianventures": (
            "getro",
            "https://jobs.acadianventures.com/companies",
            "collectionId",
            "acadianventures",
        ),
        "raleighfounded": (
            "getro",
            "https://jobs.raleighfounded.com/companies",
            "collectionId",
            "raleighfounded",
        ),
        "voltcapital": (
            "getro",
            "https://opportunities.volt.capital/companies",
            "collectionId",
            "voltcapital",
        ),
        "sequel": (
            "getro",
            "https://jobs.sequel.co/companies",
            "collectionId",
            "sequel",
        ),
        "calibratevc": (
            "getro",
            "https://jobs.calibratevc.com/companies",
            "collectionId",
            "calibratevc",
        ),
        "catalyticcapital": (
        ...
        "panache": (
            "getro",
            "https://portfoliojobs.panache.vc/companies",
            "collectionId",
            "panache",
        ),
        "7pc": (
            "getro",
            "https://jobs.7pc.vc/companies",
            "collectionId",
            "7pc",
        ),
        "doen": (
            "getro",
            "https://impactjobs.doen.nl/companies",
            "collectionId",
            "doen",
        ),
        "chemstars": (
            "getro",
            "https://jobs.chemstars.de/companies",
            "collectionId",
            "chemstars",
        ),
        "daphnivc": (
            "getro",
            "https://talent.daphni.com/companies",
            "collectionId",
            "daphnivc",
        ),
        "photonjobs": (
            "getro",
            "https://find.photonjobs.nl/companies",
            "collectionId",
            "photonjobs",
        ),
        "imaginablefutures": (
            "getro",
            "https://jobs.imaginablefutures.com/companies",
            "collectionId",
            "imaginablefutures",
        ),
        "cintrifuse": (
            "getro",
            "https://jobs.cintrifuse.com/companies",
            "collectionId",
            "cintrifuse",
        ),
        "mazeimpact": (
            "getro",
            "https://jobs.maze-impact.com/companies",
            "collectionId",
            "mazeimpact",
        ),
        "structure": (
            "getro",
            "https://jobs.structure.vc/companies",
            "collectionId",
            "structure",
        ),
        "runacap": (
            "getro",
            "https://talent.runacap.com/companies",
            "collectionId",
            "runacap",
        ),
        "dnx": (
            "getro",
            "https://jobs.dnx.vc/companies",
            "collectionId",
            "dnx",
        ),
        "fintopcapital": (
            "getro",
            "https://jobs.fintopcapital.com/companies",
            "collectionId",
            "fintopcapital",
        ),
        "ethicsinsociety": (
            "getro",
            "https://ethicsinsociety.getro.com/companies",
            "collectionId",
            "ethicsinsociety",
        ),
        "mystartupgig": (
            "getro",
            "https://au.mystartupgig.com/companies",
            "collectionId",
            "mystartupgig",
        ),
        "heartcorevc": (
            "getro",
            "https://jobs.heartcore.com/companies",
            "collectionId",
            "heartcorevc",
        ),
        "safe": (
            "getro",
            "https://jobs.safe.global/",
            "collectionId",
            "safe",
        ),
        "cre": (
            "getro",
            "https://jobs.cre.vc/companies",
            "collectionId",
            "cre",
        ),
        "inflectionvc": (
            "getro",
            "https://jobs.inflection.xyz/companies",
            "collectionId",
            "inflectionvc",
        ),
        "near": (
            "getro",
            "https://careers.near.org/companies",
            "collectionId",
            "near",
        ),
        "hedera": (
            "getro",
            "https://careers.hedera.community/companies",
            "collectionId",
            "hedera",
        ),
        "pennyjar": (
            "getro",
            "https://jobs.pennyjar.com/companies",
            "collectionId",
            "pennyjar",
        ),
        "magnify": (
            "getro",
            "https://jobs.magnify.vc/companies",
            "collectionId",
            "magnify",
        ),
        "moonfirevc": (
            "getro",
            "https://positions.moonfire.com/companies",
            "collectionId",
            "moonfirevc",
        ),
        "tekfenventures": (
            "getro",
            "https://careers.tekfenventures.com/companies",
            "collectionId",
            "tekfenventures",
        ),
        "optimism": (
            "getro",
            "https://jobs.optimism.io/companies",
            "collectionId",
            "optimism",
        ),
        "monad": (
            "getro",
            "https://eco-jobs.monad.xyz/companies",
            "collectionId",
            "monad",
        ),
        "discovertechnata": (
            "getro",
            "https://jobs.discovertechnata.com/companies",
            "collectionId",
            "discovertechnata",
        ),
        "shieurope": (
            "getro",
            "https://shi-europe.getro.com/companies",
            "collectionId",
            "shieurope",
        ),
        "getro": (
            "getro",
            "https://www.getro.org/companies",
            "collectionId",
            "getro",
        ),
        "itspronounceddata": (
            "getro",
            "https://itspronounceddata.getro.com/companies",
            "collectionId",
            "itspronounceddata",
        ),
        "pillarvc": (
            "getro",
            "https://jobs.pillar.vc/companies",
            "collectionId",
            "pillarvc",
        ),
        "ritualcapital": (
            "getro",
            "https://careers.ritualcapital.com/companies",
            "collectionId",
            "ritualcapital",
        ),
        "theclimatepledge": (
        ...
        "shakopeemn": (
            "getro",
            "https://jobs.shakopeemn.gov/companies",
            "collectionId",
            "shakopeemn",
        ),
        "zilliqa": (
            "getro",
            "https://jobs.zilliqa.com/companies",
            "collectionId",
            "zilliqa",
        ),
        "lorimerventures": (
            "getro",
            "https://jobs.lorimerventures.com/companies",
            "collectionId",
            "lorimerventures",
        ),
        "ritualcapitaljobs": (
            "getro",
            "https://jobs.ritualcapital.com/companies",
            "collectionId",
            "ritualcapitaljobs",
        ),
        "shakopeemnjobs": (
            "getro",
            "https://jobs.shakopeemn.gov/jobs",
            "collectionId",
            "shakopeemnjobs",
        ),
        ...
        "nebari": (
            "getro",
            "https://jobs.nebari.com/companies",
            "collectionId",
            "nebari",
        ),
        "zilliqajobs": (
            "getro",
            "https://jobs.zilliqa.com/jobs",
            "collectionId",
            "zilliqajobs",
        ),
        "consider": (
        ...
        "workinthehague": (
            "getro",
            "https://jobs.workinthehague.nl/companies",
            "collectionId",
            "workinthehague",
        ),
        "spacecapital": (
            "getro",
            "https://jobs.spacecapital.com/companies",
            "collectionId",
            "spacecapital",
        ),
        "bdb": (
            "getro",
            "https://jobs.bdb.org/companies",
            "collectionId",
            "bdb",
        ),
        "solana": (
            "getro",
            "https://jobs.solana.com/companies",
            "collectionId",
            "solana",
        ),
        "bartowcareers": (
            "getro",
            "https://bartowcareers.getro.com/companies",
            "collectionId",
            "bartowcareers",
        ),
        "pfgrowth": (
            "getro",
            "https://jobs.pfgrowth.com/companies",
            "collectionId",
            "pfgrowth",
        ),
        "startuplab": (
            "getro",
            "https://jobs.startuplab.no/companies",
            "collectionId",
            "startuplab",
        ),
        "eifo": (
            "getro",
            "https://jobs.eifo.dk/companies",
            "collectionId",
            "eifo",
        ),
        "collabcurrency": (
            "getro",
            "https://jobs.collabcurrency.com/companies",
            "collectionId",
            "collabcurrency",
        ),
        "fintechbelgium": (
            "getro",
            "https://careers.fintechbelgium.be/companies",
            "collectionId",
            "fintechbelgium",
        ),
        "joinimagine": (
            "getro",
            "https://jobs.joinimagine.com/companies",
            "collectionId",
            "joinimagine",
        ),
        "longhash": (
            "getro",
            "https://careers.longhash.vc/companies",
            "collectionId",
            "longhash",
        ),
        "chicagoquantum": (
            "getro",
            "https://jobs.chicagoquantum.org/companies",
            "collectionId",
            "chicagoquantum",
        ),
        "bullpencap": (
            "getro",
            "https://talent.bullpencap.com/companies",
            "collectionId",
            "bullpencap",
        ),
        "compound": (
            "getro",
            "https://jobs.compound.vc/companies",
            "collectionId",
            "compound",
        ),
        "knoxtech": (
            "getro",
            "https://jobs.knoxtech.org/companies",
            "collectionId",
            "knoxtech",
        ),
        "burntislandventures": (
        ...
        "camford": (
            "getro",
            "https://jobs.camford.vc/companies",
            "collectionId",
            "camford",
        ),
        "tscp": (
            "getro",
            "https://careers.tscp.com/companies",
            "collectionId",
            "tscp",
        ),
        "mainshares": (
            "getro",
            "https://jobs.mainshares.com/companies",
            "collectionId",
            "mainshares",
        ),
        "asugsvsummit": (
            "getro",
            "https://jobs.asugsvsummit.com/companies",
            "collectionId",
            "asugsvsummit",
        ),
        "avemaria": (
            "getro",
            "https://jobs.avemaria.edu/companies",
            "collectionId",
            "avemaria",
        ),
        "merantix": (
            "getro",
            "https://careers.merantix.com/companies",
            "collectionId",
            "merantix",
        ),
        "group11": (
            "getro",
            "https://jobs.group11.vc/companies",
            "collectionId",
            "group11",
        ),
        "hl": (
            "getro",
            "https://careers.h-l.vc/companies",
            "collectionId",
            "hl",
        ),
        "wayfinder": (
            "getro",
            "https://careers.wayfinder.com/companies",
            "collectionId",
            "wayfinder",
        ),
        "prefaceventures": (
            "getro",
            "https://careers.prefaceventures.com/companies",
            "collectionId",
            "prefaceventures",
        ),
        "mtechcapital": (
            "getro",
            "https://jobs.mtechcapital.com/companies",
            "collectionId",
            "mtechcapital",
        ),
        "rampersand": (
            "getro",
            "https://rampersand.getro.com/companies",
            "collectionId",
            "rampersand",
        ),
        "nolavateblack": (
            "getro",
            "https://jobs.nolavateblack.com/companies",
            "collectionId",
            "nolavateblack",
        ),
        "syfy": (
            "getro",
            "https://jobs.syfy.io/companies",
            "collectionId",
            "syfy",
        ),
        "wintermute": (
